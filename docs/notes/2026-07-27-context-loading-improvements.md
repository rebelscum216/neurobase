...
> ### Corrections ledger
>
> **[R4]** Every position either agent reversed, by round and severity — the point
> of keeping `[Rn]` markers inline rather than editing silently. An earlier
> revision of this ledger claimed exhaustiveness while omitting four round-1
...
> its particulars, and establishing that required a reviewer with independent
> filesystem access rather than a second reading of the same evidence.
